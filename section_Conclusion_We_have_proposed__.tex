...
To quickly find enriched set of molecules with high fitness values, we have proposed to use Thompson sampling as our data collection strategy. We have described how to use this method to collect data
