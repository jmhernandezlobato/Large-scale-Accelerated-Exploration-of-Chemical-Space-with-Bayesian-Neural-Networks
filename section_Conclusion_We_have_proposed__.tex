...
We have proposed to use Bayesian neural networks as the workhorse for building adaptive design tools to accelerate the discovery of new molecular compounds in high-throughput screening settings. Traditionally, working with large Bayesian neural networks and large amounts of data was challenging because of the lack of tools for accurate approximate inference. We have avoided this problem by leveraging on a recent advance in this area called probabilistic back-propagation. Our Bayesian neural networks can be trained on large amounts of data and 
can learn feature representations for the data, what improves their statistical efficiency. 
