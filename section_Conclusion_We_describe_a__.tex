...
We have proposed to use Bayesian neural networks to as the main workhorse in an adaptive design tool
for accelerating the discovery of new molecular compounds.
