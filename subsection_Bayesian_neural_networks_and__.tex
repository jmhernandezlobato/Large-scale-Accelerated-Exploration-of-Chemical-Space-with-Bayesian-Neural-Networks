...
Neural networks work by composing multiple layers of linear transformations followed by element-wise non-linearities. 
They are universal function approximations, capable of representing continuous functions with arbitrary precision providing
