\subsection{Data set visualization: search landscapes}\label{sec:data_sets}
...
problem of developing good treatments for this particular type of cancer. In the Malaria data set, the promising areas of chemical space are more uniformly distributed across the middle of the plot, with a clear discontinuity in the central square area.