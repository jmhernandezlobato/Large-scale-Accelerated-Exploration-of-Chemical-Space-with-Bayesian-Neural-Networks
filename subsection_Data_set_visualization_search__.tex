...
problem of developing treatments for cancer. In the Malaria data set, the promising areas of chemical space are more uniformly distributed across the middle of the plot.