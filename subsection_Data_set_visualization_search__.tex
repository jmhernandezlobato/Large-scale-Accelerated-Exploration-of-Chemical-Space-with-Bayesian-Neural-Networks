...
The data is propagated forward from the bottom layer to the top one. The network
...
this process, the bottom part of the mirrored funnel architecture, that is, the
